  ...
  func set(style: LetterCellStyle) {
    // START YOUR CODE HERE
      ...
      case .initial:
          ...
          layer.borderColor = UIColor.gray.cgColor
      case .incorrect:
          contentView.backgroundColor = UIColor.init(red: 0.23, green: 0.23, blue: 0.24, alpha: 1.0)
          layer.borderColor = UIColor.init(red: 0.23, green: 0.23, blue: 0.24, alpha: 1.0).cgColor
      case .correctLetterOnly:
          contentView.backgroundColor = UIColor.init(red: 0.69, green: 0.63, blue: 0.30, alpha: 1.0)
          layer.borderColor = UIColor.init(red: 0.69, green: 0.63, blue: 0.30, alpha: 1.0).cgColor
      case.correctLetterAndPosition:
          contentView.backgroundColor = UIColor.init(red: 0.38, green: 0.55, blue: 0.33, alpha: 1.0)
          layer.borderColor = UIColor.init(red: 0.38, green: 0.55, blue: 0.33, alpha: 1.0).cgColor
